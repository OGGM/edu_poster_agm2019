...
\title{OGGM Edu: \vspace*{-5cm}\hspace*{0.625\textwidth}{\includegraphics[width=0.36\textwidth]{oggm_loupe_niedriger}}\\ \vspace*{-5cm}A collaborative educational platform \\about glaciers }
...
%% first box
		\begin{boxblock}{}
						{\large \textbf{OGGM Edu} is an open source homepage developed collaboratively, where different learning ressources about glaciers and glacier modelling are provided.}
		\end{boxblock}
...
% second row with two boxes
	\begin{minipage}[t]{36cm}
		...
		\begin{boxblock}{Aims}
				\begin{itemize}
						\item Interactive education: for students and material for teachers
						\item Collaboration with everyone, who is interested \\$\rightarrow$ collective advancement
